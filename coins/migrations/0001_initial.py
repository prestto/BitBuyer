    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate_close', models.DecimalField(decimal_places=2, max_digits=5)),
                ('rate_high', models.DecimalField(decimal_places=2, max_digits=5)),
                ('rate_low', models.DecimalField(decimal_places=2, max_digits=5)),
                ('rate_open', models.DecimalField(decimal_places=2, max_digits=5)),
