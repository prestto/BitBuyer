...
class CoinPrices(models.Model):
    ...
    rate_close = models.DecimalField(max_digits=18, decimal_places=11)
    rate_high = models.DecimalField(max_digits=18, decimal_places=11)
    rate_low = models.DecimalField(max_digits=18, decimal_places=11)
    rate_open = models.DecimalField(max_digits=18, decimal_places=11)
